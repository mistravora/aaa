    ...
    const products: Product[] = [
      {
        id: '1',
        sku: 'DC001',
        name_en: 'Premium Dark Chocolate 85%',
        name_si: 'ප්‍රීමියම් කළු චොකලට් 85%',
        name_ta: 'பிரீமியம் டார்க் சாக்லேட் 85%',
        category: 'Chocolates',
        base_unit: 'pcs',
        default_sale_unit: 'pcs',
        allowed_sale_units: ['pcs'],
        price_base: 1200,
        barcodes: ['4791234567890', 'DC-001-2024'],
      ...
      },
      {
        id: '2',
        sku: 'DC002',
        name_en: 'Milk Chocolate Truffles Premium',
        name_si: 'කිරි චොකලට් ට්‍රෆල් ප්‍රීමියම්',
        name_ta: 'மில்க் சாக்லேட் ட்ரஃபிள்ஸ் பிரீமியம்',
        category: 'Chocolates',
        base_unit: 'g',
        default_sale_unit: 'kg',
        allowed_sale_units: ['kg', 'g', '100g'],
        price_base: 6.8,
        barcodes: ['4791234567891', 'DC-002-2024'],
        requires_expiry: true,
        min_stock: 1000,
      ...
      },
      {
        id: '3',
        sku: 'DC003',
        name_en: 'Chocolate Coated Dates',
        name_si: 'චොකලට් ආලේපිත දෙහි',
        name_ta: 'சாக்லேட் கோட்டட் டேட்ஸ்',
        category: 'Dates & Nuts',
        base_unit: 'g',
        default_sale_unit: 'kg',
        allowed_sale_units: ['kg', 'g', '100g'],
        price_base: 4.5,
        barcodes: ['4791234567892', 'DC-003-2024'],
        requires_expiry: true,
        min_stock: 2000,
      ...
      },
      {
        id: '4',
        sku: 'DC004',
        name_en: 'Chocolate Coated Cashews',
        name_si: 'චොකලට් ආලේපිත කජු',
        name_ta: 'சாக்லேட் கோட்டட் காஷு',
        category: 'Dates & Nuts',
        base_unit: 'g',
        default_sale_unit: 'kg',
        allowed_sale_units: ['kg', 'g', '100g'],
        price_base: 5.2,
        barcodes: ['4791234567893', 'DC-004-2024'],
      ...
      },
      {
        id: '5',
        sku: 'DC005',
        name_en: 'Hot Chocolate Mix Premium',
        name_si: 'උණුසුම් චොකලට් මිශ්‍රණය ප්‍රීමියම්',
        name_ta: 'ஹாட் சாக்லேட் மிக்ஸ் பிரீமியம்',
        category: 'Beverages',
        base_unit: 'g',
        default_sale_unit: 'g',
        allowed_sale_units: ['g', '100g'],
        price_base: 0.25,
        barcodes: ['4791234567894', 'DC-005-2024'],
        requires_expiry: true,
        min_stock: 2000,
        reorder_point_days: 30,
        createdAt: new Date().toISOString(),
